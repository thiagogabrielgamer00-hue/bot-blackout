...
import com.sedmelluq.discord.lavaplayer.player.event.AudioTrackEndReason;
...
public class Main extends ListenerAdapter {
    ...
    private static final List<AudioTrack> filaMusica =
            Collections.synchronizedList(new ArrayList<>());

    private static int volumeMusica = 80;
...
CommandRegistry.registrar(jda);
    ...
    private void inicializarMusica() {
        ...
        audioPlayer.setVolume(volumeMusica);
        ...
        System.out.println(
                "[MUSIC] Sistema de música iniciado.");
    }

    private AudioTrack retirarDaFila() {

        synchronized (filaMusica) {

            if (filaMusica.isEmpty()) {
                return null;
            }

            return filaMusica.remove(0);
        }
    }
    ...
    public void onSlashCommandInteraction(
        ...
        try {
            ...
            if (nome.equals("pause")) {
                ...
                e.reply("⏸️ Música pausada.")
                        .queue();

                return;
            }

            if (nome.equals("resume")) {
                ...
                e.reply("▶️ Música retomada.")
                        .queue();

                return;
            }

            if (nome.equals("volume")) {
    ...
    private void comandoPlay(
        ...
        if (membro == null ||
                membro.getVoiceState() == null ||
                !membro.getVoiceState()
                        .inAudioChannel()) {
        ...
        audioManager.setSendingHandler(
                new net.dv8tion.jda.api.audio.AudioSendHandler() {

                    private final AudioFrameProvider provider =
                            audioPlayer.getFrameProvider();
